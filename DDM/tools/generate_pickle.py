...
# 在 generate_pickle.py 的底部添加
def main(dataroot, split, anno_path=None):
    if split == "test":
        generate_test_pickle(dataroot)
    else:
        generate_pickle(split=split, dataroot=dataroot, anno_path=anno_path)
        
if __name__ == "__main__":
    args = parse_args()
    main(dataroot=args.dataroot, split=args.split, anno_path=args.anno_path)
